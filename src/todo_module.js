...
export const todos = (() => {
  ...
  const allTodos = [
    ...
    {
      title: 'Draw cards for Vilma, Laura and Asta',
      description: 'Wrap Birthday gifts.',
      dueDate: defaultDate,
      priority: 'Priority 1',
      project: 'Personal',
      completed: false,
...
export const renderTodos = () => {
  ...
  const displayTodo = (todo) => {
    ...
    switch (true) {
      case get.priority.value === 'Priority 1' ||
        todo.priority === 'Priority 1':
        priorityElement.classList.add('green');
        break;
      case get.priority.value == 'Priority 2' || todo.priority === 'Priority 2':
        priorityElement.classList.add('orange');
        break;
      case get.priority.value == 'Priority 3' || todo.priority === 'Priority 3':
        priorityElement.classList.add('red');
        break;
    }
